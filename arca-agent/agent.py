...
def handle_service_event(event, namespace, logger, **kwargs):
    ...
    for agentconfig_name, discovery_label in agentconfigs.items():
        ...
        if namespace_labels.get(key) == value:
            ...
            print_service_details(service, logger)
...
def print_service_details(service, logger):
    """
